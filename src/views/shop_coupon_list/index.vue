...
<script setup>
import { couponListAPI, couponAPI, deleteCouponAPI, failureCouponAPI } from '@/api/coupon'
...
const handleEdit = (row) => {
  ...
  couponModel.time = [new Date(couponModel.start_time), new Date(couponModel.end_time)]
